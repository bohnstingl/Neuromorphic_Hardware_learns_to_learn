...
SPR_SETTER(set_goe, "mtspr 0b0001000011, %0")
SPR_GETTER(get_goe, "mfspr %0, 0b0001000011")

SPR_SETTER(set_gout, "mtspr 0b0001000010, %0")
SPR_GETTER(get_gin, "mfspr %0, 0b0001000001")
//---------------------------------------------------------------------------
