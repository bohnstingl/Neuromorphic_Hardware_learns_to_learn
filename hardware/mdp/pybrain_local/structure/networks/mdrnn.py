...
try:
    from arac.pybrain_localbridge import _FeedForwardNetwork #@UnresolvedImport
except:
    _FeedForwardNetwork = object
from pybrain_local.structure.modules.mdrnnlayer import MdrnnLayer
from pybrain_local.structure import LinearLayer
from pybrain_local.structure.connections.permutation import PermutationConnection
from pybrain_local.utilities import crossproduct, permute, permuteToBlocks
