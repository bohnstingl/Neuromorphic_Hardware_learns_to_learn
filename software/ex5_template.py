...
if not(WDEP):  # Task 5B, no weight dependence
    ...
    Nep = 5000  #?? # number of pattern presentations during learning
else:          # Task 5C, weight dependence
    plast_params = plast_params_wdep
    Nep =  5000   #?? # number of pattern presentations during learning

# Connection parameters
J_in = 3.3 # >= 0.5 ??   # initial strength of Input->E synapses [pA]
J_EI = 30. # >= 30 ?? # strength of E->I synapses [pA]
J_IE = -19.0 # >= 10 ??  # strength of inhibitory synapses [pA]
J_noise = 18.1 # >= 25 ?? # strength of synapses from noise input [pA]
