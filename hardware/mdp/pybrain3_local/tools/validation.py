...
import copy
from pybrain3_local3.datasets.importance import ImportanceDataSet
from pybrain3_local3.datasets.sequential import SequentialDataSet
from pybrain3_local3.datasets.supervised import SupervisedDataSet
...
class Validator(object):
    """ This class provides methods for the validation of calculated output
        ...
        not know anything about modules or other pybrain3_local stuff. It just works
...
class ModuleValidator(object):
    """ This class provides methods for the validation of calculated output
        ...
        pybrain3_locals modules and dataset classes.
    ...
    def classificationPerformance(cls, module, dataset):
        """ Returns the hit rate of the module's output compared to the targets
            ...
            :arg module: Object of any subclass of pybrain3_local's Module type
