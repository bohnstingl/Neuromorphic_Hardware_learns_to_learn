...
from pybrain_local.structure import RecurrentNetwork, FeedForwardNetwork, IdentityConnection, LinearLayer, SigmoidLayer
from pybrain_local.tests.testsuites import runModuleTestSuite
