...
try:
    from arac.pybrain3_localbridge import _FeedForwardNetwork #@UnresolvedImport
except:
    _FeedForwardNetwork = object
from pybrain3_local3.structure.modules.mdrnnlayer import MdrnnLayer
from pybrain3_local3.structure import LinearLayer
from pybrain3_local3.structure.connections.permutation import PermutationConnection
from pybrain3_local3.utilities import crossproduct, permute, permuteToBlocks
