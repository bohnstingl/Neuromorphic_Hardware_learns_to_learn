...
import copy
from pybrain_local.datasets.importance import ImportanceDataSet
from pybrain_local.datasets.sequential import SequentialDataSet
from pybrain_local.datasets.supervised import SupervisedDataSet
...
class Validator(object):
    """ This class provides methods for the validation of calculated output
        ...
        not know anything about modules or other pybrain_local stuff. It just works
...
class ModuleValidator(object):
    """ This class provides methods for the validation of calculated output
        ...
        pybrain_locals modules and dataset classes.
    ...
    def classificationPerformance(cls, module, dataset):
        """ Returns the hit rate of the module's output compared to the targets
            ...
            :arg module: Object of any subclass of pybrain_local's Module type
