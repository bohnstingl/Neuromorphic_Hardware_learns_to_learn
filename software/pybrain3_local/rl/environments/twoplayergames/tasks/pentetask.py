...
from pybrain3_local.rl.environments.twoplayergames.pente import PenteGame
from pybrain3_local.rl.environments.episodic import EpisodicTask
from .gomokutask import GomokuTask
from pybrain3_local.rl.environments.twoplayergames.gomokuplayers import RandomGomokuPlayer
