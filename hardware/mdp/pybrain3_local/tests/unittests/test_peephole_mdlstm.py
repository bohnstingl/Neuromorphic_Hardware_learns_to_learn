"""
    >>> from pybrain3_local.tests.helpers import epsilonCheck
    >>> from pybrain3_local.tools.functions import tanh
    >>> from pybrain3_local.utilities import fListToString
...
from pybrain3_local3.structure import LinearLayer, IdentityConnection, MDLSTMLayer, RecurrentNetwork
