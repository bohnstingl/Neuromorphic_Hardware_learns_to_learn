...
uint32_t const dls_randgen_base = 0xe000;
...
uint32_t* const dls_syndrv_base = (uint32_t*)((0x14000000 << 2) | (1 << 31));

/* Address of capmem configuration */
uint32_t* const dls_capmem_config_base = (uint32_t*)((0x10010000 << 2) | (1 << 31));

/* Address of capmem cell SRAM */
uint32_t* const dls_capmem_cell_base = (uint32_t*)((0x10000000 << 2) | (1 << 31));

/* Address of digital neuron mod functions */
uint32_t* const dls_nrn_digital_mod = (uint32_t*)((0x12000000 << 2) | (1 << 31));
