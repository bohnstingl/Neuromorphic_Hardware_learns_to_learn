...
from pybrain3_local3.structure.networks.recurrent import RecurrentNetwork
from pybrain3_local3.structure.modules import BiasUnit, SigmoidLayer, LinearLayer, LSTMLayer
from pybrain3_local3.structure.connections import FullConnection, IdentityConnection

try:
    from arac.pybrain3_localbridge import _RecurrentNetwork, _FeedForwardNetwork
...
def buildNetwork(*layers, **options):
    ...
    pybrain3_local implementations."""
    # options
    opt = {'bias': True,
