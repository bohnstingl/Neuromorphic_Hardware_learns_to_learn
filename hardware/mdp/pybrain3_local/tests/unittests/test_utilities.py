"""    
    >>> from pybrain3_local.utilities import memoize
    >>> call_count = 0
    >>> @memoize
    ... def longComp():
    ...   global call_count
...
=================
    ...
    >>> from pybrain3_local.utilities import permute
...
=========================
    ...
    >>> from pybrain3_local.utilities import permuteToBlocks
...
from pybrain3_local3.utilities import Serializable
