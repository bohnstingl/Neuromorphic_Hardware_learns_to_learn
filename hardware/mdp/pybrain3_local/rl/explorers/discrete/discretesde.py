...
from pybrain3_local3.rl.explorers.discrete.discrete import DiscreteExplorer
from pybrain3_local3.rl.learners.valuebased.interface import ActionValueTable, ActionValueNetwork
