...
from pybrain_local.rl.learners.learner import ExploringLearner, DataSetLearner, EpisodicLearner
from pybrain_local.rl.explorers.discrete.egreedy import EpsilonGreedyExplorer
