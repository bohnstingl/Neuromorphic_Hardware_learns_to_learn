...
from pybrain3_local.rl.environments.twoplayergames.capturegameplayers import ModuleDecidingPlayer
from pybrain3_local.rl.environments.twoplayergames.capturegame import CaptureGame
