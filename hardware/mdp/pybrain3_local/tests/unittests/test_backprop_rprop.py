"""
    ...
    >>> from pybrain3_local.supervised.trainers import BackpropTrainer, RPropMinusTrainer
    >>> from pybrain3_local.datasets import SupervisedDataSet, ImportanceDataSet
