...
from pybrain_local.rl.explorers.explorer import Explorer
from pybrain_local.tools.functions import expln, explnPrime
...
class StateDependentExplorer(Explorer, ParameterContainer):
    """ A continuous explorer, that perturbs the resulting action with
        ...
        to the expln() function (see pybrain_local.tools.functions).
    """
