...
from pybrain3_local3.rl.explorers.explorer import Explorer
from pybrain3_local3.tools.functions import expln, explnPrime
...
class StateDependentExplorer(Explorer, ParameterContainer):
    """ A continuous explorer, that perturbs the resulting action with
        ...
        to the expln() function (see pybrain3_local.tools.functions).
    """
