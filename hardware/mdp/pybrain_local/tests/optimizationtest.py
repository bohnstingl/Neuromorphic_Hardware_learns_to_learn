...
import pybrain_local.optimization.optimizer as bbo
import pybrain_local.optimization.populationbased.multiobjective as mobj
import pybrain_local.optimization as allopts

from pybrain_local.rl.environments.functions.unimodal import SphereFunction
from pybrain_local.structure.parametercontainer import ParameterContainer
from pybrain_local.structure.evolvables.evolvable import Evolvable
from pybrain_local.rl.environments.cartpole.balancetask import BalanceTask
...
if __name__ == '__main__':
    from pybrain_local.optimization import *  #@UnusedWildImport
    #from pybrain_local.optimization import CMAES #@UnusedImport
