...
from pybrain_local import SharedFullConnection, MotherConnection, MDLSTMLayer, IdentityConnection
from pybrain_local import ModuleMesh, LinearLayer, TanhLayer, SigmoidLayer
from pybrain_local.structure.networks import BorderSwipingNetwork
