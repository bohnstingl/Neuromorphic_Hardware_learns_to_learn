"""
    ...
    >>> from pybrain_local.tools.rlgluebridge import adaptAgent
...
`agent`
    ...
    >>> rlglue_agent
    <pybrain_local.tools.rlgluebridge.RlglueAgentAdapter object at ...>
    >>> type(rlglue_agent)
    <class 'pybrain_local.tools.rlgluebridge.RlglueAgentAdapter'>
...
rlglue.    
    ...
    >>> from pybrain_local.tools.rlgluebridge import BenchmarkingAgent
...
class PseudoPybrainAgent(LearningAgent):
    """A little Agent that follows the pybrain_local API for testing."""
