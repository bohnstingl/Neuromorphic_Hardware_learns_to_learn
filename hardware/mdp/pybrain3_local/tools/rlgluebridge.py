...
"""This module provides functionality to use pybrain3_local with rlglue and to use it
...
from pybrain3_local3.structure.modules.module import Module
from pybrain3_local3.rl.agents import LearningAgent
from pybrain3_local3.utilities import threaded
from pybrain3_local3.tools.benchmark import BenchmarkDataSet
...
def adaptAgent(agent_klass):
    """Return a factory function that instantiates a pybrain3_local agent and adapts
    it to the rlglue framework interface.
    
    :type   agent_klass:    subclass of some pybrain3_local agent
...
def adaptAgentObject(agent_object):
    """Return an object that adapts a pybrain3_local agent to the rlglue interface.
    """
...
class RlglueAgentAdapter(object):
    """Wrapper class to use pybrain3_local agents with the RLGlue library."""
    ...
    def __init__(self, klass, *args, **kwargs):
        ...
        :type   klass:    subclass of some pybrain3_local agent
    ...
    def agent_init(self, task_specification=None):
        ...
        Since pybrain3_local agents are not using task specifications
    ...
    def _integrateObservation(self, observation):
        ...
        it into the pybrain3_local agent.
...
class RlCompBenchmark(object):
    """Class to run benchmarks of pybrain3_local agents on the rl-competition 2007
    environments.
    """
...
# pybrain3_local environments, other ways should be found.
