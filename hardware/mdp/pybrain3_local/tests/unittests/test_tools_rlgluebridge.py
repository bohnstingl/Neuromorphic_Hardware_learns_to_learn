"""
    ...
    >>> from pybrain3_local.tools.rlgluebridge import adaptAgent
...
`agent`
    ...
    >>> rlglue_agent
    <pybrain3_local.tools.rlgluebridge.RlglueAgentAdapter object at ...>
    >>> type(rlglue_agent)
    <class 'pybrain3_local.tools.rlgluebridge.RlglueAgentAdapter'>
...
rlglue.    
    ...
    >>> from pybrain3_local.tools.rlgluebridge import BenchmarkingAgent
...
from pybrain3_local3.tests import runModuleTestSuite


class PseudoPybrainAgent(LearningAgent):
    """A little Agent that follows the pybrain3_local API for testing."""
