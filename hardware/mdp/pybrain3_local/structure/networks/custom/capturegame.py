...
from pybrain3_local3 import SharedFullConnection, MotherConnection, MDLSTMLayer, IdentityConnection
from pybrain3_local3 import ModuleMesh, LinearLayer, TanhLayer, SigmoidLayer
from pybrain3_local3.structure.networks import BorderSwipingNetwork
