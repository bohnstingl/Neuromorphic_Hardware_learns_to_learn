"""    
    >>> from pybrain_local.utilities import memoize
    >>> call_count = 0
    >>> @memoize
    ... def longComp():
    ...   global call_count
...
=================
    ...
    >>> from pybrain_local.utilities import permute
...
=========================
    ...
    >>> from pybrain_local.utilities import permuteToBlocks
...
from pybrain_local.utilities import Serializable
