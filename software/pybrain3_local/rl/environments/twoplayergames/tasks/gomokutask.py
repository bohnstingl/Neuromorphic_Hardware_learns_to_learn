...
from pybrain3_local.rl.environments.twoplayergames.gomokuplayers import RandomGomokuPlayer, ModuleDecidingPlayer
from pybrain3_local.rl.environments.twoplayergames.gomokuplayers.gomokuplayer import GomokuPlayer
