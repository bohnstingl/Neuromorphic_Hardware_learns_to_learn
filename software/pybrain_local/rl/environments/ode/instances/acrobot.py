...
from pybrain_local.rl.environments.ode import ODEEnvironment, sensors, actuators
import imp
...
class AcrobotEnvironment(ODEEnvironment):
    def __init__(self, renderer=True, realtime=False, ip="127.0.0.1", port="21590", buf='16384'):
        ...
        # load model file
        self.loadXODE(imp.find_module('pybrain_local')[1] + "/rl/environments/ode/models/acrobot.xode")
