...
from pybrain_local.structure.modules import BiasUnit, SigmoidLayer, LinearLayer, LSTMLayer
from pybrain_local.structure.connections import FullConnection, IdentityConnection

try:
    from arac.pybrain_localbridge import _RecurrentNetwork, _FeedForwardNetwork
