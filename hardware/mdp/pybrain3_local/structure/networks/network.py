...
from pybrain3_local3.utilities import combineLists
from pybrain3_local3.structure.connections.shared import SharedConnection
...
class Network(Module, ParameterContainer):
    ...
    def convertToFastNetwork(self):
        ...
        from pybrain3_local.structure.networks import FeedForwardNetwork, RecurrentNetwork
        try:
            from arac.pybrain3_localbridge import _RecurrentNetwork, _FeedForwardNetwork #@UnresolvedImport
        except:
