...
import pybrain3_local3.optimization.optimizer as bbo
import pybrain3_local3.optimization.populationbased.multiobjective as mobj
import pybrain3_local3.optimization as allopts

from pybrain3_local3.rl.environments.functions.unimodal import SphereFunction
from pybrain3_local3.structure.parametercontainer import ParameterContainer
from pybrain3_local3.structure.evolvables.evolvable import Evolvable
from pybrain3_local3.rl.environments.cartpole.balancetask import BalanceTask
from pybrain3_local3.tools.shortcuts import buildNetwork
...
if __name__ == '__main__':
    from pybrain3_local.optimization import *  #@UnusedWildImport
    #from pybrain3_local.optimization import CMAES #@UnusedImport
