...
from pybrain_local.structure.moduleslice import ModuleSlice
...
from pybrain_local.utilities import combineLists
from pybrain_local.structure.connections.shared import SharedConnection
...
class Network(Module, ParameterContainer):
    ...
    def convertToFastNetwork(self):
        ...
        from pybrain_local.structure.networks import FeedForwardNetwork, RecurrentNetwork
        try:
            from arac.pybrain_localbridge import _RecurrentNetwork, _FeedForwardNetwork #@UnresolvedImport
        except:
