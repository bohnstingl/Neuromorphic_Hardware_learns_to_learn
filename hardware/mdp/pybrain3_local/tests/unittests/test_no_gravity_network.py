...
from pybrain3_local3.structure import RecurrentNetwork, FeedForwardNetwork, IdentityConnection, LinearLayer, SigmoidLayer
from pybrain3_local3.tests.testsuites import runModuleTestSuite
