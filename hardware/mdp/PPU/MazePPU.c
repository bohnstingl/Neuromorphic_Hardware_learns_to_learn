//This define is used to be compatible to computer and chip compilation
#define CHIP 1
//This defines the update rule.
//PLAST 0 ... weight update TD(1)
//PLAST 1 ... weight update TD(lambda)
#define PLAST 0
...
void weightUpdate()
{
    ...
    for (uint32_t vectorIndex = 2; vectorIndex < (2 + MDP_STATES * 2); vectorIndex++)
    {
