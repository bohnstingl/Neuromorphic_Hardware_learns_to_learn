...
from NetworkMaze_Optimizee import DLSMazeOptimizee

logger = logging.getLogger('bin.ltl-fun-gd')


def main():
    name = 'LTL-MAZE-GD_3x3'
    try:
    ...
    optimizee = DLSMazeOptimizee(traj)
    ...
    #parameters = AdamParameters(learning_rate=0.01, exploration_step_size=0.01, n_random_steps=20, first_order_decay=0.8,
    #                             second_order_decay=0.8, n_iteration=32, stop_criterion=np.Inf, seed=99)
    ...
    #                               n_random_steps=15, momentum_decay=0.5,
    #                               n_iteration=63, stop_criterion=np.Inf, seed=99)
