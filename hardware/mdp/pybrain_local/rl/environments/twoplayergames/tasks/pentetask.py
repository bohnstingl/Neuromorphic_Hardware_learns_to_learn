...
from pybrain_local.rl.environments.twoplayergames.pente import PenteGame
from pybrain_local.rl.environments.episodic import EpisodicTask
from gomokutask import GomokuTask
from pybrain_local.rl.environments.twoplayergames.gomokuplayers import RandomGomokuPlayer
