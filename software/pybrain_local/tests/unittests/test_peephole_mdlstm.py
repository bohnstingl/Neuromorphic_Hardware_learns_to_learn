"""
    >>> from pybrain_local.tests.helpers import epsilonCheck
    >>> from pybrain_local.tools.functions import tanh
    >>> from pybrain_local.utilities import fListToString
...
from pybrain_local.structure import LinearLayer, IdentityConnection, MDLSTMLayer, RecurrentNetwork
