...
from pybrain3_local.rl.learners.learner import ExploringLearner, DataSetLearner, EpisodicLearner
from pybrain3_local.rl.explorers.discrete.egreedy import EpsilonGreedyExplorer
